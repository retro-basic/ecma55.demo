...
are intended to demonstrate the behavior of ECMA-55 conforming interpreters
or compilers.
...
The Minimal BASIC demo programs are located in the `src/` directory.
...
See `doc/demo-doc.txt` for a description of each demo program.


## 4. Security level

All ECMA-55 Minimal BASIC demo programs have security level *medium*. They
